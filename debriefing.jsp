...
<tr><td>
    ...
    <p class="text">Thank you for your participation.  We are investigating a surprising finding about people's tendency to identify with groups.  Humans are an extremely social species.  Previous studies have found that people have a strong tendency to form groups and identify with others whenever they have a chance to do so.  Just being randomly assigned to a group of new people is enough to produce favoritism for members of one's own group over others.  In this study, we are investigating an interesting variation of this finding.  Prior studies suggest that merely seeing pictures of one group makes it more likely that we will identify with that group over another.  We did this with pictures of Asian and Black people.  All participants saw pictures of one of these groups.  Then, participants completed an Implicit Association Test measuring associations of Asian people and Black people with oneself. If seeing people is enough to identify with them, then the IAT results should be influenced by which group you saw. Do you think your results were affected by which people you saw at the beginning?
	</p>
